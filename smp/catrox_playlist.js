...
g_properties.add_properties(
    {
        ...
        show_rating:          ['user.row.rating.show', _cc('foo_playcount') && !g_is_mini_panel],
...
var g_component_utils = _cc('foo_utils');
...
//---> Playlist Manager
g_pl_colors.playlist_mgr_text_normal = _RGB(190, 172, 196);
g_pl_colors.playlist_mgr_text_hovered = _RGB(216, 204, 219);
g_pl_colors.playlist_mgr_text_pressed = _RGB(130, 105, 137);
//---> Header
g_pl_colors.group_title = _RGB(190, 172, 196);
...
g_pl_colors.album_normal = _RGB(190, 172, 196);
g_pl_colors.album_playing = g_pl_colors.album_normal;
g_pl_colors.info_normal = _RGB(190, 172, 196);
g_pl_colors.info_playing = g_pl_colors.info_normal;
g_pl_colors.date_normal = _RGB(190, 172, 196);
...
//---> Row
g_pl_colors.title_selected = _RGB(171, 174, 243);
g_pl_colors.title_playing = _RGB(218, 167, 235);
g_pl_colors.title_normal = g_theme.colors.panel_text_normal;
g_pl_colors.count_normal = _RGB(190, 172, 196);
g_pl_colors.count_selected = g_pl_colors.title_selected;
g_pl_colors.count_playing = g_pl_colors.title_playing;
g_pl_colors.row_selected = _RGB(13, 17, 94);
g_pl_colors.row_alternate = _RGB(37, 37, 46);
g_pl_colors.row_focus_selected = g_theme.colors.panel_line_selected;
g_pl_colors.row_focus_normal = _RGB(41, 44, 112);
g_pl_colors.row_queued = _RGBA(150, 150, 150, 0);
g_pl_colors.row_drop_position = _RGB(218, 167, 235);
