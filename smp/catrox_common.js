...
g_theme.colors = {};
g_theme.colors.pss_back = _RGB(25, 25, 35);
g_theme.colors.panel_back = _RGB(25, 25, 35);
g_theme.colors.panel_front = _RGB(37, 37, 46);
g_theme.colors.panel_line = _RGB(77, 77, 108);
g_theme.colors.panel_line_selected = g_theme.colors.panel_line;
g_theme.colors.panel_text_normal = _RGB(190, 172, 196);
